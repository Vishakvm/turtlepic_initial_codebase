...
export default function PRThankyouVariantView(): React.ReactElement {
      ...
      <Section>
        ...
        <Wrapper>
          ...
          <Typography textAlign="center" variant="h5">
            You will be exclusively receiving the pictures from the event.
          </Typography>
          <Typography textAlign="center" variant="h5">
            You can always come back later and take a selfie to save yourself from all the

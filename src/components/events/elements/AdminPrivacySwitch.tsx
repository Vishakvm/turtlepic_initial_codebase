...
export default function AdminPrivacySwitchElement(props: SwitchProps): React.ReactElement {
  return (
    <Grid container spacing={2}>
      ...
      <Grid item md={3} sm={4} xs={5}>
        <Stack direction="row" py={1} alignItems="center">
          ...
          <Switch name={props.name} checked={props.checked} onChange={props.onChange} />

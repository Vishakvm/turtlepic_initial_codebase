...
export default function TransferredEventsTab(): React.ReactElement {
    ...
    try {
      await axios
        .post(`/api/events/search`, {
          ...
          filters: [{ field: 'client_status', operator: '=', value: TRANSFERRED }],
        })
        .then((response) => {
  ...
  }, [enqueueSnackbar, user?.account_type]);
            ...
            <GridStyle key={i} item={true} container md={3} sm={6} xs={12}>
              <Folder>
                ...
                <ActionWrapper>
                  ...
                  {user?.account_type === AGENCY && ele.client_status !== TRANSFERRED && (
                    <ShareIcon
                      onClick={() => {
